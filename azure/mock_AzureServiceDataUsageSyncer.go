...
type mockConstructorTestingTNewMockAzureServiceDataUsageSyncer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockAzureServiceDataUsageSyncer(t mockConstructorTestingTNewMockAzureServiceDataUsageSyncer) *MockAzureServiceDataUsageSyncer {
